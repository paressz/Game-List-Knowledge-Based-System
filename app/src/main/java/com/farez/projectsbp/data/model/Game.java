...
public class Game implements Serializable {
    ...
    public static List<Game> sampleGameList() {
        ...
        list.add(new GameBuilder()
                ...
                .setRam(4)
                .setHdd(16)
                .setVga("Nvidia GeForce 9600GT / AMD Radeon HD 6570 / Intel HD 4600 Integrated Graphics")
                .setDeskripsi("League of Legends, commonly referred to as League, is a 2009 multiplayer online battle arena video game developed and published by Riot Games. Inspired by Defense of the Ancients, a custom map for Warcraft III, Riot's founders sought to develop a stand-alone game in the same genre.")
        ...
        list.add(new GameBuilder()
                ...
                .setRam(8)
                .setHdd(85)
                .setVga("Any GPU type but need at least 1gb or more vram")
        ...
        list.add(new GameBuilder()
                ...
                .setCpu("Intel Pentium 4 or AMD Phenom")
                .setRam(1)
                .setHdd(15)
        ...
        list.add(
                new GameBuilder()
                        ...
                        .createGame());
        list.add(new GameBuilder()
                        .setNama("Cyberpunk 2077")
                        .setCpu("Core i7-6700 / Ryzen 5 1600 / Core i7-12700 / Ryzen 7 7800X3D")
                        .setRam(12)
                        .setHdd(70)
        ...
        list.add(new GameBuilder()
                        .setNama("ELDEN RING")
                        .setCpu("Intel Core i5-8400 / AMD ryzen 3 3300X")
                        .setRam(12)
                        .setHdd(60)
        ...
        list.add(new GameBuilder()
                        ...
                        .setCpu(" Intel i5-8400 / AMD Ryzen 5 1600")
                        .setRam(8)
                        .setHdd(130)
        ...
        list.add(new GameBuilder()
                        ...
                        .setCpu("Intel i5-4590 / AMD Ryzen 3 1200")
                        .setRam(8)
                        .setHdd(50)
        ...
        list.add(new GameBuilder()
                        ...
                        .setCpu("Intel Core i5-6600 / AMD Ryzen 3 3100 / Ryzen 5 2600")
                        .setRam(8)
                        .setHdd(100)
        ...
        list.add(new GameBuilder()
                        .setNama("Rust")
                        .setCpu("Intel Core i7-3770 / AMD FX-9590")
                        .setRam(10)
                        .setHdd(25)
        ...
        list.add(new GameBuilder()
                        .setNama("Lies of P")
                        .setCpu("Intel Core i3-6300 / AMDRyzen 3 1200")
                        .setRam(8)
                        .setHdd(50)
        ...
        list.add(new GameBuilder()
                        ...
                        .setCpu("Intel Core i5-6600K 3.50GHz / AMD Ryzen 5 1600  3.2 GHZ")
                        .setRam(8)
                        .setHdd(100)
        ...
        list.add(new GameBuilder()
                        ...
                        .setCpu(" Intel CPU Core i5-2500K 3.3GHz / AMD A10-5800K APU 3.8GHz")
                        .setRam(6)
                        .setHdd(50)
        ...
        list.add(new GameBuilder()
                        ...
                        .setCpu(" Intel Core 2 Duo E8400 / AMD Phenom II X4 965")
                        .setRam(4)
                        .setHdd(1)
        ...
        list.add(new GameBuilder()
                        ...
                        .setCpu("Intel Core i5-4590 / AMD FX-4350")
                        .setRam(8)
                        .setHdd(30)
        ...
        list.add(new GameBuilder()
                        ...
                        .setCpu("Intel Core i7-4770K / AMD Ryzen 5 1500X")
                        .setRam(12)
                        .setHdd(150)
        ...
        list.add(new GameBuilder()
                        ...
                        .setCpu("AMD Ryzen 5 1500X / Intel Core i7-4770K")
                        .setRam(16)
                        .setHdd(100)
        ...
        list.add(new GameBuilder()
                        ...
                        .setCpu(" Intel Core i3-530 2.93 GHz / AMD Phenom II X4 810 2.60 GHz")
                        .setRam(6)
                        .setHdd(100)
